...
Username<br/> <input class="form-control-lg" value={username} onInput={(e)=>{this.state.username=(e.target.value)}} type="text" name="username" /><br/><br/>
Password<br/> <input class="form-control-lg" value={password} onInput={(e)=>{this.state.password=(e.target.value)}} type="password" name="password"/><br/><br/>
